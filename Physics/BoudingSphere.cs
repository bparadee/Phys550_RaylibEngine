...
namespace Physics550Engine_Raylib.Physics
{
    public class BoudingSphere : IBoundingShape
    {
        ...
        //need to add callback to update values when parent changes.
        ...
        private Color _debug_color { get; set; }
        ...
        public BoudingSphere(Vector3 offset, float radius, INode parent_node)
        {
            ...
            _global_position = Vector3.Transform(_parent_node._position, Matrix4x4.CreateTranslation(_offset));
        }
